...
namespace DPA.Application
{
    public interface IDepartmentService
    {
        ...
        Task<IResult> UpdateFirstSyylabusAsync(long departmentId, long firstSyllabusId);
        Task<IResult> UpdateSecondSyylabusAsync(long departmentId, long secondSyllabusId);
