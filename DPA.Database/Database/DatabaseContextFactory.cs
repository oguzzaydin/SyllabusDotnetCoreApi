...
namespace DPA.Database.Database
{
    public sealed class DatabaseContextFactory : IDesignTimeDbContextFactory<DatabaseContext>
    {
        ...
        {
            const string connectionString = "Server=DESKTOP-8KG7SA7\\SQLEXPRESS;DESKTOP-3GVQRBO\\SQLEXPRESS;Database=DpaDB;Integrated Security=true;Connection Timeout=5;";
